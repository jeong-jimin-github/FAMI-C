...
CONSTANTS: List[Tuple[str, int, str, bool]] = [
    ...
    ("NOISE_HAT", 2, "asset song 노이즈: 닫은 하이햇", False),
    ("NOISE_HAT_OPEN", 3, "asset song 노이즈: 열린 하이햇", False),
    ("NOISE_KICK", 4, "asset song 노이즈: 킥", False),
    ("NOISE_SNARE", 5, "asset song 노이즈: 스네어", False),
    ("NOISE_TOM", 6, "asset song 노이즈: 톰", False),
    ("NOISE_CYMBAL", 7, "asset song 노이즈: 심벌", False),
